            ...
            <nav>
                <div className="nav-content">
                    <div className="luxury">
                        <img src="https://cdn.pixabay.com/photo/2020/08/05/13/12/eco-5465432_1280.png" alt="" className="logo" />
                        <div>
                    ...
                    <div className="nav-links">
                        ...
                        <button className="nav-button cart-button" onClick={handleCartClick}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" height="32" width="32">
                                ...
                                <circle cx="80" cy="216" r="16" fill="white"/>
                                <circle cx="184" cy="216" r="16" fill="white"/>
